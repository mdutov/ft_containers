...
/* 
   1)	Корень дерева только ЧЕРНЫЙ;

   2)	Лист дерева только ЧЕРНЫЙ и имеет значение NIL;

   3)	Ребенок красного узла только ЧЕРНЫЙ;

   4)	Для каждого узла все пути до листьев
...
class RBTree{
	...
	private:
		...
		//------------------------------functions to provide property of tree------------------------------
